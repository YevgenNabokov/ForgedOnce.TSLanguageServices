...
class TypeParser {
    ...
    static createTypeReference(initializer) {
        let result = { Array: null, Parenthesized: null, Literal: null, Named: null, Union: null, Intersection: null, NotSupported: null, Tuple: null, LiteralType: null, IndexedAccess: null };
        initializer(result);
        return result;
    }
