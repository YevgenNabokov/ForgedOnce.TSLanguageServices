...
namespace ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel
{
    public class StExternalModuleReference : ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StNode, ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.IStModuleReference
    {
        ...
        {
            return new ForgedOnce.TsLanguageServices.FullSyntaxTree.TransportModel.ExternalModuleReference()
