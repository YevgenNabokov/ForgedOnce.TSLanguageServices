...
namespace ForgedOnce.TsLanguageServices.FullSyntaxTree.AstBuilder
{
    public static partial class StBlockExtensions
    {
        ...
        public static ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StBlock WithDecorator(this ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StBlock subject, ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StDecorator decorator)
        {
