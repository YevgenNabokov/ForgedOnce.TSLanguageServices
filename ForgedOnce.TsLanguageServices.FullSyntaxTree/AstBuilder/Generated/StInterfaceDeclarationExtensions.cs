...
namespace ForgedOnce.TsLanguageServices.FullSyntaxTree.AstBuilder
{
    public static partial class StInterfaceDeclarationExtensions
    {
        ...
        public static ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StInterfaceDeclaration WithTypeParameter(this ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StInterfaceDeclaration subject, ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StTypeParameterDeclaration typeParameter)
        {
            subject.typeParameters.Add(typeParameter);
            return subject;
        }

        public static ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StInterfaceDeclaration WithHeritageClaus(this ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StInterfaceDeclaration subject, ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StHeritageClause heritageClaus)
        {
        ...
        public static ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StInterfaceDeclaration WithDecorator(this ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StInterfaceDeclaration subject, ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StDecorator decorator)
        {
