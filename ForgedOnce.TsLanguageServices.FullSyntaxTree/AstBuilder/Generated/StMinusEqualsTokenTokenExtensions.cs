...
namespace ForgedOnce.TsLanguageServices.FullSyntaxTree.AstBuilder
{
    public static partial class StMinusEqualsTokenTokenExtensions
    {
        ...
        public static ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StMinusEqualsTokenToken WithDecorator(this ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StMinusEqualsTokenToken subject, ForgedOnce.TsLanguageServices.FullSyntaxTree.AstModel.StDecorator decorator)
        {
