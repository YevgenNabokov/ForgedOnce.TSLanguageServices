...
export class Converter {
    public ConvertNode(node: any): any { if (node == null) {
        return undefined;
        ...
        var paramVar0: any = this.ConvertNodes(node.members);
        return T.createTypeLiteralNode(paramVar0);
    } if (node.kind == T.SyntaxKind.MappedType) {
        var paramVar0: any = this.ConvertNode(node.readonlyToken);
        var paramVar1: any = this.ConvertNode(node.typeParameter);
        var paramVar2: any = this.ConvertNode(node.questionToken);
        var paramVar3: any = this.ConvertNode(node.type);
        ...
        var paramVar0: any = this.ConvertNode(node.left);
        var paramVar1: any = this.ConvertNode(node.operatorToken);
        var paramVar2: any = this.ConvertNode(node.right);
        return T.createBinary(paramVar0, paramVar1, paramVar2);
    } if (node.kind == T.SyntaxKind.ArrowFunction) {
        var paramVar0: any = this.ConvertNodes(node.modifiers);
        var paramVar1: any = this.ConvertNodes(node.typeParameters);
        var paramVar2: any = this.ConvertNodes(node.parameters);
        var paramVar3: any = this.ConvertNode(node.type);
        var paramVar4: any = this.ConvertNode(node.equalsGreaterThanToken);
        var paramVar5: any = this.ConvertNode(node.body);
        ...
        var paramVar1: any = this.ConvertNodes(node.typeArguments);
        var paramVar2: any = this.ConvertNodes(node.arguments);
        ...
        var paramVar0: any = this.ConvertNodes(node.modifiers);
        var paramVar1: any = this.ConvertNode(node.declarationList);
        ...
        var paramVar0: any = this.ConvertNode(node.label);
        var paramVar1: any = this.ConvertNode(node.statement);
        ...
        var paramVar2: any = this.ConvertNode(node.dotDotDotToken);
        var paramVar3: any = this.ConvertNode(node.name);
        var paramVar4: any = this.ConvertNode(node.questionToken);
        var paramVar5: any = this.ConvertNode(node.type);
        var paramVar6: any = this.ConvertNode(node.initializer);
        ...
        var paramVar0: any = this.ConvertNodes(node.decorators);
        var paramVar1: any = this.ConvertNodes(node.modifiers);
        var paramVar2: any = this.ConvertNode(node.asteriskToken);
        var paramVar3: any = this.ConvertNode(node.name);
        var paramVar4: any = this.ConvertNodes(node.typeParameters);
        var paramVar5: any = this.ConvertNodes(node.parameters);
        var paramVar6: any = this.ConvertNode(node.type);
        var paramVar7: any = this.ConvertNode(node.body);
        ...
        var paramVar3: any = this.ConvertNodes(node.typeParameters);
        var paramVar4: any = this.ConvertNodes(node.heritageClauses);
        var paramVar5: any = this.ConvertNodes(node.members);
        ...
        var paramVar2: any = this.ConvertNode(node.name);
        var paramVar3: any = this.ConvertNodes(node.typeParameters);
        var paramVar4: any = this.ConvertNode(node.type);
        ...
        var paramVar1: any = this.ConvertNode(node.initializer);
        return T.createEnumMember(paramVar0, paramVar1);
    } if (node.kind == T.SyntaxKind.EnumDeclaration) {
        var paramVar0: any = this.ConvertNodes(node.decorators);
        var paramVar1: any = this.ConvertNodes(node.modifiers);
        var paramVar2: any = this.ConvertNode(node.name);
        var paramVar3: any = this.ConvertNodes(node.members);
        ...
        var paramVar1: any = this.ConvertNodes(node.modifiers);
        var paramVar2: any = this.ConvertNode(node.name);
        var paramVar3: any = this.ConvertNode(node.moduleReference);
        ...
        var paramVar0: any = this.ConvertNodes(node.decorators);
        var paramVar1: any = this.ConvertNodes(node.modifiers);
        var paramVar2: any = this.ConvertNode(node.exportClause);
        var paramVar3: any = this.ConvertNode(node.moduleSpecifier);
        ...
        var paramVar0: any = this.ConvertNodes(node.typeParameters);
        var paramVar1: any = this.ConvertNodes(node.parameters);
        var paramVar2: any = this.ConvertNode(node.type);
        ...
        var paramVar2: any = this.ConvertNode(node.questionToken);
        var paramVar3: any = this.ConvertNode(node.type);
        var paramVar4: any = this.ConvertNode(node.initializer);
        ...
        var paramVar1: any = this.ConvertNodes(node.modifiers);
        var paramVar2: any = this.ConvertNode(node.name);
        var paramVar3: any = this.ConvertNode(node.questionToken);
        var paramVar4: any = this.ConvertNode(node.type);
        var paramVar5: any = this.ConvertNode(node.initializer);
        ...
        var paramVar0: any = this.ConvertNode(node.name);
        var paramVar1: any = this.ConvertNode(node.objectAssignmentInitializer);
        ...
        var paramVar3: any = this.ConvertNode(node.name);
        var paramVar4: any = this.ConvertNode(node.questionToken);
        var paramVar5: any = this.ConvertNodes(node.typeParameters);
        var paramVar6: any = this.ConvertNodes(node.parameters);
        var paramVar7: any = this.ConvertNode(node.type);
        var paramVar8: any = this.ConvertNode(node.body);
        ...
        var paramVar1: any = this.ConvertNodes(node.modifiers);
        var paramVar2: any = this.ConvertNode(node.name);
        var paramVar3: any = this.ConvertNodes(node.parameters);
        var paramVar4: any = this.ConvertNode(node.type);
        var paramVar5: any = this.ConvertNode(node.body);
        ...
        var paramVar2: any = this.ConvertNode(node.name);
        var paramVar3: any = this.ConvertNodes(node.parameters);
        var paramVar4: any = this.ConvertNode(node.body);
        ...
        var paramVar0: any = this.ConvertNodes(node.modifiers);
        var paramVar1: any = this.ConvertNode(node.name);
        var paramVar2: any = this.ConvertNodes(node.typeParameters);
        var paramVar3: any = this.ConvertNodes(node.heritageClauses);
        var paramVar4: any = this.ConvertNodes(node.members);
        ...
        var paramVar0: any = this.ConvertNodes(node.modifiers);
        var paramVar1: any = this.ConvertNode(node.asteriskToken);
        var paramVar2: any = this.ConvertNode(node.name);
        var paramVar3: any = this.ConvertNodes(node.typeParameters);
        var paramVar4: any = this.ConvertNodes(node.parameters);
        var paramVar5: any = this.ConvertNode(node.type);
        var paramVar6: any = this.ConvertNode(node.body);
        ...
        var paramVar0: any = this.ConvertNode(node.left);
        var paramVar1: any = this.ConvertNode(node.right);
        ...
        var paramVar0: any = this.ConvertNode(node.variableDeclaration);
        var paramVar1: any = this.ConvertNode(node.block);
        ...
        var paramVar0: any = this.ConvertNodes(node.types);
        ...
        var paramVar0: any = this.ConvertNode(node.checkType);
        var paramVar1: any = this.ConvertNode(node.extendsType);
        var paramVar2: any = this.ConvertNode(node.trueType);
        var paramVar3: any = this.ConvertNode(node.falseType);
        return T.createConditionalTypeNode(paramVar0, paramVar1, paramVar2, paramVar3);
    } if (node.kind == T.SyntaxKind.InferType) {
        var paramVar0: any = this.ConvertNode(node.typeParameter);
        ...
        var paramVar0: any = this.ConvertNode(node.objectType);
        var paramVar1: any = this.ConvertNode(node.indexType);
        return T.createIndexedAccessTypeNode(paramVar0, paramVar1);
    } if (node.kind == T.SyntaxKind.LiteralType) {
        var paramVar0: any = this.ConvertNode(node.literal);
        ...
        var paramVar0: any = this.ConvertNode(node.condition);
        var paramVar1: any = this.ConvertNode(node.whenTrue);
        var paramVar2: any = this.ConvertNode(node.whenFalse);
        ...
        var paramVar0: any = this.ConvertNode(node.tagName);
        var paramVar1: any = this.ConvertNodes(node.typeArguments);
        var paramVar2: any = this.ConvertNode(node.attributes);
        ...
        var paramVar0: any = this.ConvertNode(node.dotDotDotToken);
        var paramVar1: any = this.ConvertNode(node.expression);
        ...
        var paramVar0: any = this.ConvertNode(node.expression);
        var paramVar1: any = this.ConvertNode(node.thenStatement);
        var paramVar2: any = this.ConvertNode(node.elseStatement);
        ...
        var paramVar0: any = this.ConvertNode(node.expression);
        var paramVar1: any = this.ConvertNode(node.caseBlock);
        ...
        var paramVar0: any = this.ConvertNode(node.tryBlock);
        var paramVar1: any = this.ConvertNode(node.catchClause);
        var paramVar2: any = this.ConvertNode(node.finallyBlock);
        return T.createTry(paramVar0, paramVar1, paramVar2);
    } if (node.kind == T.SyntaxKind.ImportDeclaration) {
        var paramVar0: any = this.ConvertNodes(node.decorators);
        var paramVar1: any = this.ConvertNodes(node.modifiers);
        var paramVar2: any = this.ConvertNode(node.importClause);
        var paramVar3: any = this.ConvertNode(node.moduleSpecifier);
        return T.createImportDeclaration(paramVar0, paramVar1, paramVar2, paramVar3);
    } if (node.kind == T.SyntaxKind.TypeParameter) {
        var paramVar0: any = this.ConvertNode(node.name);
        var paramVar1: any = this.ConvertNode(node.constraint);
        var paramVar2: any = this.ConvertNode(node.default);
        return T.createTypeParameterDeclaration(paramVar0, paramVar1, paramVar2);
    } if (node.kind == T.SyntaxKind.VariableDeclaration) {
        var paramVar0: any = this.ConvertNode(node.name);
        var paramVar1: any = this.ConvertNode(node.type);
        var paramVar2: any = this.ConvertNode(node.initializer);
        return T.createVariableDeclaration(paramVar0, paramVar1, paramVar2);
    } if (node.kind == T.SyntaxKind.BindingElement) {
        var paramVar0: any = this.ConvertNode(node.dotDotDotToken);
        var paramVar1: any = this.ConvertNode(node.propertyName);
        var paramVar2: any = this.ConvertNode(node.name);
        var paramVar3: any = this.ConvertNode(node.initializer);
        return T.createBindingElement(paramVar0, paramVar1, paramVar2, paramVar3);
    } if (node.kind == T.SyntaxKind.ImportType) {
        var paramVar0: any = this.ConvertNode(node.argument);
        var paramVar1: any = this.ConvertNode(node.qualifier);
        var paramVar2: any = this.ConvertNodes(node.typeArguments);
        ...
        var paramVar0: any = this.ConvertNode(node.typeName);
        var paramVar1: any = this.ConvertNodes(node.typeArguments);
        ...
        var paramVar0: any = this.ConvertNodes(node.typeArguments);
        var paramVar1: any = this.ConvertNode(node.expression);
        ...
        var paramVar0: any = this.ConvertNode(node.statement);
        var paramVar1: any = this.ConvertNode(node.expression);
        ...
        var paramVar0: any = this.ConvertNode(node.initializer);
        var paramVar1: any = this.ConvertNode(node.condition);
        var paramVar2: any = this.ConvertNode(node.incrementor);
        var paramVar3: any = this.ConvertNode(node.statement);
        return T.createFor(paramVar0, paramVar1, paramVar2, paramVar3);
    } if (node.kind == T.SyntaxKind.ForInStatement) {
        var paramVar0: any = this.ConvertNode(node.initializer);
        var paramVar1: any = this.ConvertNode(node.expression);
        var paramVar2: any = this.ConvertNode(node.statement);
        return T.createForIn(paramVar0, paramVar1, paramVar2);
    } if (node.kind == T.SyntaxKind.ForOfStatement) {
        var paramVar0: any = this.ConvertNode(node.awaitModifier);
        var paramVar1: any = this.ConvertNode(node.initializer);
        var paramVar2: any = this.ConvertNode(node.expression);
        var paramVar3: any = this.ConvertNode(node.statement);
        return T.createForOf(paramVar0, paramVar1, paramVar2, paramVar3);
    } if (node.kind == T.SyntaxKind.ImportClause) {
        var paramVar0: any = this.ConvertNode(node.name);
        var paramVar1: any = this.ConvertNode(node.namedBindings);
        ...
        var paramVar0: any = this.ConvertNode(node.propertyName);
        var paramVar1: any = this.ConvertNode(node.name);
        ...
        var paramVar0: any = this.ConvertNodes(node.decorators);
        var paramVar1: any = this.ConvertNodes(node.modifiers);
        var paramVar3: any = this.ConvertNode(node.expression);
        ...
        var paramVar0: any = this.ConvertNode(node.expression);
        var paramVar1: any = this.ConvertNode(node.argumentExpression);
        return T.createElementAccess(paramVar0, paramVar1);
    } if (node.kind == T.SyntaxKind.TaggedTemplateExpression) {
        var paramVar0: any = this.ConvertNode(node.tag);
        var paramVar1: any = this.ConvertNode(node.template);
        ...
        var paramVar0: any = this.ConvertNode(node.head);
        var paramVar1: any = this.ConvertNodes(node.templateSpans);
        ...
        var paramVar1: any = this.ConvertNodes(node.children);
        var paramVar2: any = this.ConvertNode(node.closingElement);
        ...
        var paramVar0: any = this.ConvertNode(node.openingFragment);
        var paramVar1: any = this.ConvertNodes(node.children);
        var paramVar2: any = this.ConvertNode(node.closingFragment);
    ...
    public ConvertNodes(nodes: Array<any>): Array<any> { if (nodes == null) {
        return undefined;
    } var result: Array<any> = new Array<any>(); for (var i: number = 0; i < nodes.length; i++)
        result.push(this.ConvertNode(nodes[i])); return result; }
}
